	...
	function(){ 
		$("#zonename").change( 
			function(){ 
				    ...
				    $.ajax({
						type : "POST",
						url: 'http://localhost/project1/index.php/orderCloud/getPackagesByZoneid',
						data : {'zoneid' : zoneid},
						datatype : 'json',
...
//								alert(obj.length);
							...
							for(var i=0; i<obj.length; i++){ 
								...
								$('#'+obj[i]).click(
									function(){
										...
										$.ajax({
											type : "POST",
											url: 'http://localhost/project1/index.php/orderCloud/getOSlist',
		...
		$("#os").change(
				function(){
					$.ajax({
						type : "POST",
						url: 'http://localhost/project1/index.php/orderCloud/getDatadisklist',
	...
	$('#servername :button').click(function(){
		...
		$.ajax({
			type : 'GET',
			url : "http://localhost/project1/index.php/orderCloud/checkVirtualMachineName/"+ checkname,
			success : function(data){ 
...
// 	 	alert(usageplantype);
		...
		showObj(orderdata);
	 	...
	 	$.ajax({
			type : "POST",
			url: 'http://localhost/project1/index.php/orderCloud/orderVM',
			data : orderdata,
			//datatype : 'json',
			success : function(data)
			{
