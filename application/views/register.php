<div>  
  ...
  <div class="span4">
    ...
    <form class="form-horizontal" action="/project1/index.php/auth/register" method="post">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" id="apikey" name="apikey" value="<?php echo set_value('apikey'); ?>"   placeholder="apikey">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">secretkey</label>
        <div class="controls">
          <input type="text" id="secretkey" name="secretkey" value="<?php echo set_value('secretkey'); ?>"   placeholder="secretkey">
        </div>
      </div>
      <div class="control-group">
